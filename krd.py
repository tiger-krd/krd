...
def chk():
  ...
  print("\n\n\x1b[33;1m YOUR ID : \033[94m"+id) 

  try: 

    httpCaht = requests.get("https://raw.githubusercontent.com/X-tiger-X/terminator/main/active.txt").text 
    ...
    if id in httpCaht: 
      ...
      print("\033[0;93m BO KREN NAMA BNERA BO @Terminator_Dev") 
      print("\033[0;93m NRXE 1 MANG 5$ @Terminator_Dev") 
